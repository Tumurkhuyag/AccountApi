...
//                 <PrimaryButton text='Choose a Photo'/>
//             </View>

//             <View>
//                 <PrimaryButton text='Take a Photo'/>
//             </View>
//         </View>
//     </View>
//   )
...
export default class SignUpAddPhotoScreen extends React.Component {
  state = {
    image: null,
  };
    ...
    let { image } = this.state;
      ...
      return (
          <View behavior='padding' style={{flex: 1, flexDirection: 'column', justifyContent: 'space-between', marginHorizontal: 20,}}>
              ...
              <View style={{flexDirection: 'column', marginBottom: 30,}}>
                  <View style={{marginBottom: 10}}>
                      <PrimaryButton text='Choose a Photo' onPress={this._pickImage}/>
                  </View>

                  <View>
                      <PrimaryButton text='Take a Photo' onPress={this._takeImage}/>
                  </View>
              </View>
          </View>
      );
